...
def create_session(
    ...
    sess = add_session(
        ...
        payload.audio_path, payload.video_path, payload.max_seconds or 120,
    )
...
def multimodal_session(payload: dict):
    """
    Flexible multimodal analysis — supply any combination of transcript,
    audio_path and video_path. Insights are generated per channel supplied.
    """
